...
// TODO: User should be able to template their AdditionalContent w/ dynamic information from the intrinsic (ipxe)
//  parameters.
...
type (
	AdditionalContent struct {
		// Name is the name given to the AdditionalContent. Name can be used to be templated into the IPXE configuration.
