...
type (
	AdditionalConfig struct {
		// Name is the name given to the AdditionalConfig. Name can be used to be templated into the IPXE configuration.
		Name string `json:"name"`

		// Exposed when set to true will expose the content of the file to `/config/UUID`. The UUID is generated by the
		// operator.
		// When "Exposed", specifying `{{ .AdditionalConfig.YOUR_CONFIG }}` in other additionalConfigs or in the ipxe
		...
		// Such resources can be ConfigMap, Secrets or any other kind of (custom) resources.
		ObjectRef *ObjectRef `json:"fromResource,omitempty"`
